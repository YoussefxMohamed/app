  ...
  if (embed3.content === prefix + "embed3") {
    const bot = new Discord.RichEmbed()
      .setColor("#FFEB3B")
    	...
    	.addField(`
عدم اثارة  المشاكل في السيرفر او ع الخاص
احترام خصوصية الاخرين وعدم احراجهم
مراعاة نظام كل روم و سياسته وقوانينه
ممنوع السبام أو إرسال بكثرة بوقت قصير
ممنوع طلب المال - بطاقات الستور - الألعاب
يمنع دخول السيرفر بالأسماء والصور الغير لائقة
يمنع نشر الروابط مثل السيرفرات , المقاطع , التويتش
احترم جميع الموجودين في السيرفر احترم المشرفين
`, true)
