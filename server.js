...
var argresult = message.content.split(` `).slice(1).join(' ');
  ...
  if (!message.guild) return message.reply('**This Command Just In Servers**')
     ...
     message.channel.sendMessage(`> **# - Premium Number:** **[** ${number} **]**\n> **# - Ends in:** **[** ${ex} **]**\n> **# - Owner:** **[** <@${owner}> **]**`);
     }
});
  ...
  if (command == "say") {
    if (!message.member.hasPermission("ADMINISTRATOR"))
      return message.channel.send(
        "?|**`ADMINISTRATOR`ليس لديك صلاحيات`** <a:4357_ByBLKCREATIONdiamante:606976611253747715> "
      );
  ...
  if (pixelbot.content.startsWith(prefix + "user")) {
    ...
    pixelbot.guild.fetchInvites().then(invites => {
      ...
      let pixeluser = new Discord.RichEmbed() // itzZa1D - Codes Team.
        ...
        .addField(
          "**✽ Tag :** <a:4357_ByBLKCREATIONdiamante:606976611253747715>  ",
          pixelbot.author.discriminator,
          true
        )
        .addField(
          "**✽ ID :** <a:4357_ByBLKCREATIONdiamante:606976611253747715>  ",
          pixelbot.author.id,
          true
        ) // itzZa1D - Codes Team.
        .addField(
          "**✽ Joined At :** <a:4357_ByBLKCREATIONdiamante:606976611253747715>  ",
          moment(pixelbot.joinedAt).format("D/M/YYYY h:mm a "),
          true
        )
        .addField(
          "**✽ Created At :** <a:4357_ByBLKCREATIONdiamante:606976611253747715>   ",
          moment(pixelbot.joinedAt).format("D/M/YYYY h:mm a "),
          true
        )
        .addField(
          "**✽ Total invites :** <a:6196_Party_Blob_Reverse_78906:606976629226602496>   ",
          inviteCount,
          true
        )
...
client.on("message", zaid => {
  if (zaid.content === "=bot") {
    const bot = new Discord.RichEmbed()
      ...
      .setColor("#00000")
      .addField(
        "✽ **Bot Ping** : <a:6196_Party_Blob_Reverse_78906:606976629226602496>",
        `» ${Date.now() - zaid.createdTimestamp}` + " ms",
        true
      )
      .addField(
        "✽ **Servers** : <a:6196_Party_Blob_Reverse_78906:606976629226602496> ",
        `» ${client.guilds.size}`,
        true
      )
      .addField(
        "✽ **Channels** : <a:6196_Party_Blob_Reverse_78906:606976629226602496> ",
        `» ${client.channels.size} `,
        true
      )
      .addField(
        "✽ **Users** : <a:6196_Party_Blob_Reverse_78906:606976629226602496> ",
        `» ${client.users.size} `,
        true
      )
      .addField(
        "✽ **Bot Name** : <a:6196_Party_Blob_Reverse_78906:606976629226602496> ",
        `» ${client.user.tag} `,
        true
      )
      .addField(
        "✽ **Bot Owner** : <a:6196_Party_Blob_Reverse_78906:606976629226602496> ",
        `» <@456487489440579595>`,
        true
      ) // Change Your ID
      .setImage(
    ...
    message.guild.fetchInvites().then(invs => {
      ...
      var inviteInfo = new Discord.RichEmbed()
        ...
        .addField(
          ...
          `**➥** [ شخص **${Number(
            inviteCount
          )}** ] <a:6196_Party_Blob_Reverse_78906:606976629226602496>  `
        )
        .addField(
          "**تاريخ انضمامك لسيرفرنا **",
          `**➥** [ منذ  **${daysJoined.toFixed(
            0
          )}** يوم ] <a:6196_Party_Blob_Reverse_78906:606976629226602496>  `
        )
        .addField(
          "**رابط الدعوة الذي دخلت منه** <a:6196_Party_Blob_Reverse_78906:606976629226602496>  ",
          `**➥** [ **https://discord.gg/${inviteCode ||
            "Zm2U6we"}** ] <a:6196_Party_Blob_Reverse_78906:606976629226602496>  `
        )
        .setImage(
          "https://cdn.discordapp.com/attachments/523532054499950602/607172616905555971/fx-long.gif"
        )
  ...
  if (message.content.startsWith("مسح")) {
    ...
    message.channel
      ...
      .then(msgs => {
        message.channel
          .send(
            `** Done , Deleted \`${msgs.size}\` messages.**<a:6196_Party_Blob_Reverse_78906:606976629226602496> `
          )
          .then(messages => messages.delete(5000));
      });
  }
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "server")) {
    ...
    var embed = new Discord.RichEmbed()
      ...
      .addField(
        `<a:6196_Party_Blob_Reverse_78906:606976629226602496>✽** Members ** [${message.guild.members.size}]`,
        `**${
...
client.on("message", message => {
  if (message.content === "=close") {
    ...
    message.channel
      ...
      .then(() => {
        message.reply("تم تقفيل الشات <a:emoji_1:573518188785041409>");
      });
  }
  if (message.content === "=open") {
    ...
    message.channel
      ...
      .then(() => {
        message.reply("تم فتح الشات <a:emoji_1:573518188785041409> ");
      });
  }
});
...
client.on("guildCreate", guild => {
  const embed = new Discord.RichEmbed() ///Codes
    ...
    .setTitle(`**Rad Bot**`).setDescription(`**  
   ✽   **__Server Name__** <a:4357_ByBLKCREATIONdiamante:606976611253747715>→ ${guild.name}
   ✽    **__Server Owner__* <a:4357_ByBLKCREATIONdiamante:606976611253747715>→ ${guild.owner}
   ✽    **__Server ID__** <a:4357_ByBLKCREATIONdiamante:606976611253747715>→ ${guild.id}
   ✽   **__Mebmers Count__** <a:4357_ByBLKCREATIONdiamante:606976611253747715>→ ${guild.memberCount}
   ✽   **__Server Count__** <a:4357_ByBLKCREATIONdiamante:606976611253747715>→ ${client.guilds.size}**`);
  client.channels.get("620596242422038579").sendEmbed(embed);
});
client.on("guildDelete", guild => {
  const embed = new Discord.RichEmbed()
    .setColor("red")
...
client.on("message", async message => {
  ...
  if (message.content == prefix + "starts") {
    if (!message.guild.member(message.author).hasPermission("MANAGE_GUILD"))
      return message.channel.send(
        ":heavy_multiplication_x:| **يجب أن يكون لديك خاصية التعديل على السيرفر**"
      );
    message.channel
      .send(`:eight_pointed_black_star:| **من فضلك اكتب اسم الروم**`)
      .then(msgg => {
        message.channel
          ...
          .then(collected => {
            ...
            msgg
              .edit(
                ":eight_pointed_black_star:| **اكتب مدة القيف اواي بالدقائق , مثال : 60**"
              )
              .then(msg => {
                message.channel
                  .awaitMessages(filter, {
                          ...
                          .then(collected => {
                            ...
                            try {
                              let giveEmbed = new Discord.RichEmbed()
                                ...
                                .setDescription(
                                  `**المدة** : ${duration /
                                    60000} ** دقائق** <a:party_parrot:606976910349697034> `
                                )
                                .setFooter(
                                  message.author.username,
                                  message.author.avatarURL
                                ...
                                .then(m => {
                                  ...
                                  setTimeout(() => {
                                    ...
                                    let endEmbed = new Discord.RichEmbed()
                                      ...
                                      .addField(
                                        "انتهى القيف اواي !",
                                        `الفائز هو <a:party_parrot:606976910349697034>  : ${gFilter}`
                                      )
                                      .setFooter(
                                        message.guild.name,
                                        message.guild.iconURL
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "mvall")) {
    ...
    if (message.member.voiceChannel == null)
      return message.channel.send(
        `**You Have To Be In Room Voice**<a:4357_ByBLKCREATIONdiamante:606976611253747715>`
      );
    ...
    message.channel.send(
      `**:white_check_mark: Success Moved All To Your Channel**<a:4357_ByBLKCREATIONdiamante:606976611253747715>`
    );
  }
});
      ...
      serverQueue.textChannel
        .send({
          embed: new Discord.RichEmbed()
            ...
            .addField(
              "✽ **Video Created at** :<a:4357_ByBLKCREATIONdiamante:606976611253747715>",
              `${fuck.datePublished}`,
              true
            )
            .addField(
...
client.on("message", message => {
  ...
  if (message.content === prefix + "1help") {
    message.channel.send(
      `**<a:5845_tickgreen:606976631566893056>| تــم رســال اوامــر الــعــامــه فــى الــخــاص ..**`
    );
...
client.on("message", message => {
  ...
  if (message.content === prefix + "3help") {
    message.channel.send(
      `**<a:5845_tickgreen:606976631566893056>| تــم رســال اوامــر الــمــوســيــقــى فــى الــخــاص ..**`
    );
...
client.on("message", message => {
  ...
  if (message.content === prefix + "4help") {
    message.channel.send(
      `**<a:5845_tickgreen:606976631566893056>| تــم رســال اوامــر الــحــمــايــة فــى الــخــاص ..**`
    );
...
client.on("message", message => {
  ...
  if (message.content === prefix + "5help") {
    message.channel.send(
      `**<a:5845_tickgreen:606976631566893056>| تــم رســال اوامــر مــمــيــزه فــى الــخــاص ..**`
    );
...
client.on("message", message => {
  ...
  if (command == prefix + "قبول") {
    ...
    if (!member) return;
    let role = message.guild.roles.find("name", "✽ under test ✽");
    if (!role) return;
    member.addRole(role);
    let embed = new Discord.RichEmbed()
      .setColor("#36393e")
...
client.on("message", msg => {
  if (msg.content === "باك") {
    msg.reply(
      "** ولكم نورت :sparkling_heart: :wink:** <a:4357_ByBLKCREATIONdiamante:606976611253747715> "
    );
  }
});
...
client.on("message", msg => {
  if (msg.content === "هاي") {
    msg.reply(
      "** هاي يا عسل   :kissing_heart: :heart: **<a:4357_ByBLKCREATIONdiamante:606976611253747715>"
    );
  }
});
...
client.on("message", msg => {
  if (msg.content === "بحبك") {
    msg.reply(
      "**عيب :joy:  **<a:4357_ByBLKCREATIONdiamante:606976611253747715>"
    );
  }
});
...
client.on("guildCreate", guild => {
  var embed = new Discord.RichEmbed().setImage(
    ...
    .setDescription(` ✽ **Thank You for Adding  Bot To Your Server**  ✽ <a:4357_ByBLKCREATIONdiamante:606976611253747715>
   ✽ **Support Server** [ • https://discord.gg/X9esPBy • ]  ✽ <a:4357_ByBLKCREATIONdiamante:606976611253747715>`);
...
if(message.content.startsWith(prefix + "limit")) {
    ...
    if(message.content.startsWith(prefix + "limittime")) {
        ...
        message.channel.send(`**→ | Changed Times limit to : ${config[message.guild.id].time}.** <a:4357_ByBLKCREATIONdiamante:606976611253747715>  `)
    }
...
client.on("channelDelete", async channel => {
    ...
    if (!anti[channel.guild.id + entry.id]) {//WESO
...
client.on('message', message => {
    ...
    var prefix = "="; //prefix
    if(!replyMSG[message.author.id]) replyMSG[message.author.id] = {
        contentmessage: "none",
        replayMessage: "none"
    }
    saveReplay();
    ...
    if(message.content.startsWith(prefix+"reply")){
        ...
        message.channel.send("<a:8299_Loading:610549601963081760> |** من فضلك اكتب الرساله الان...** <a:d6:622838885365579826>").then(msg => {
            message.channel.awaitMessages(filter, {//R.I.P Royal Bot!
                maxMatches: 1,
                time: 12000,
                errors: ['time']
            })
            ...
            .then(collected => {
                ...
                .then(collectedd => {
                    ...
                    msg.edit("<a:5845_tickgreen:606976631566893056>  |** تم الاعداد بنجاح...** ")
