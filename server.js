                      ...
                      try {
                        ...
                        message.guild.channels
                          ...
                          .then((m) => {
                            ...
                            setTimeout(() => {
                              let users = m.reactions.get(
                                "a:HyperTada:922517074771865600"
                              ).users;
                              let list = users
                                .array()
                                .filter(
                              ...
                              if (gFilter === undefined) {
                                let endEmbed = new Discord.RichEmbed()
                                  ...
                                  .setTimestamp();
                                m.edit(
                                  "** <a:HyperTada:922517074771865600> GIVEAWAY ENDED <a:HyperTada:922517074771865600>**",
                                  {
                                    embed: endEmbed,
                                  }
                                );
...
//discord server : https://discord.gg/jVbcMxbj , Name : Oliver.#7305 
      ...
      Creator Auto Line : <@${linedata[message['guild'].id].by}>
